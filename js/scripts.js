...
/* ".innerHTML" is only needed at the end of a command if you plan
on changing the contents of the id selected, but if you just need 
to select the value for a var, dont use it, follow the example below.*/
